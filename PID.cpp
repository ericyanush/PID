...
/**
 * Constructs the PIDController object with PID Gains of 1
 */
PID::PID()
{
    _kp = 1;
...
/**
 * Constructs the PIDController object with PID Gains
...
/**
 * This method calculates the PID output. This method should be run as
...
/**
 * Returns the latest output generated by this PIDController.
...
/**
 * Returns the maximum value that the integral value can accumulate to.
 * @return The maximum value that the integral value can accumulate to.
 */
